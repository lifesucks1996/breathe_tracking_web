...
def mostrar_resultados(resultados):
    ...
    print("=" * 70)
    print(f"\nℹ️  Fecha de prueba: {resultados['timestamp']}")
...
def limpiar_datos_sensores(db, sensor_id=None):
    ...
    """
    print("🗑️  Iniciando limpieza de datos...\n")
    
    try:
        if sensor_id is None:
            # Limpiar TODO
            print("⚠️  ADVERTENCIA: Se eliminarán TODOS los sensores")
        ...
        for s_id in sensores_ids:
            try:
                ...
                print(f"⚠️  Error al eliminar {s_id}: {e}")
...
def main():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            confirmacion = input("\n⚠️  ADVERTENCIA: Esto eliminará TODOS los sensores.\n¿Continuar? (s/n): ")
